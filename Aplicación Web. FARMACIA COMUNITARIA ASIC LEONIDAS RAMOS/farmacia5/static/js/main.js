...
$(document).ready(function() {
    $('#btn_pass_show').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#password2', button);
    });

    $('#btn_pass_show1').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_password1', button);
    });

    $('#btn_pass_show2').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_password2', button);
    });

    $('#btn_pass_show3').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_password1_reset', button);
    });

    $('#btn_pass_show4').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_password2_reset', button);
    });

    $('#btn_pass_show5').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_password_actual', button);
    });

    $('#btn_pass_show6').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_new_password', button);
    });

    $('#btn_pass_show7').click(function() {
    	var button = $(this);
        togglePasswordVisibility('#id_new_password2', button);
    });

    function togglePasswordVisibility(passwordInputId, button) {
